    ...
    return (
      <div className="flex relative flex-col md:flex-row justify-between w-full py-10 md:py-32 bg-white animate-pulse">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0 md:pl-20 pl-6">
          ...
          <Skeleton variant="text" width={250} height={30} animation="wave" sx={{ mt: 2 }} />
          <Skeleton variant="rectangular" width={150} height={40} animation="wave" sx={{ mt: 3, borderRadius: '4px' }} />
            ...
            <Box sx={{ display: 'flex', gap: 2, mt: 2 }}>
              {[...Array(4)].map((_, i) => (
                <Box key={i} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <Skeleton variant="rectangular" width={50} height={50} animation="wave" sx={{ borderRadius: '4px' }} />
